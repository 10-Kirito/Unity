...
public class MapCreation1 : MonoBehaviour
{
// 1. 用来装饰地图的物体
    // 0. 家 1. 墙 2. 障碍 3. 河流 4. 草 5. 空气墙 6. 敌人出生特效 7. 玩家一出生特效. 8. 玩家二出生特效
    ...
    {
        InitMap();
        EnemyController.isDouble = true;
        PlayerController.isDouble = true;
        PlayerController2.isDouble = true;
        Heart.isDouble = true;
    }
    ...
    private void InitMap()
    {
        ...
        GameObject player2 = Instantiate(item[8], new Vector3(2, -8, 0), Quaternion.identity);
